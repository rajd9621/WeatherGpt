...
2. Right-click `WeatherGPT.html` → "Open with Live Server"
...
1. **Parse Query** — extracts the user's intent (weather, rain, alerts, etc.) and the place name
2. **Geocode** — converts the place name to latitude/longitude via Open-Meteo Geocoding API
3. **Fetch Forecast** — gets current conditions, hourly, and 7-day forecast data
4. **Detect Alerts** — checks for heat waves, heavy rain, thunderstorms, high winds, extreme UV
5. **Build Response** — formats a conversational answer with metrics and warnings
...
3. Save — your app will be live at `https://<your-username>.github.io/WeatherGPT/WeatherGPT.html`
